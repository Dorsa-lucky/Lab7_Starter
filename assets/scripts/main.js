...
function bindPopstate() {
  ...
  window.addEventListener('popstate', function(event){
    ...
    console.log("state is",event.state);
    //console.log("key_state is",event.state.key_state);
    if(event.state != null && event.state.key_state != null){
      router.navigate(event.state.key_state, true);
